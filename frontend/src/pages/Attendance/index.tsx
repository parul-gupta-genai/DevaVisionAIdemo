...
import { BadgeCheck, Users, HardHat, UserSquare2, ScanFace } from 'lucide-react';
    ...
    <div className="h-full w-full p-2 md:p-8 overflow-y-auto custom-scrollbar">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            <h1 className="text-3xl md:text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-teal-600 mb-2 tracking-tight flex items-center gap-3">
              <BadgeCheck className="w-8 h-8 text-emerald-500" />
              Workforce Attendance
            </h1>
            <p className="text-muted-foreground font-medium text-sm">
              Unified presence tracking: AI Face Recognition, Logs, and Staff Management.
            </p>
          </div>
        ...
        <div className="pt-2 pb-10">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              {activeTab === 'face' && <FaceRecognitionTab />}
            </motion.div>
          </AnimatePresence>
        </div>
